...
var desiredLabels = []*github.Label{
	...
	{Name: github.String("needs-documentation"), Color: github.String("b72243")},
	{Name: github.String("needs-tests"), Color: github.String("5140a5")},
	{Name: github.String("not-reproduced"), Color: github.String("ba1771")},
	...
	{Name: github.String("pinned"), Color: github.String("f3f4d3")},
        {Name: github.String("priority 1 (must)"), Color: github.String("222222")},
        {Name: github.String("priority 2 (should)"), Color: github.String("888888")},
        {Name: github.String("priority 3 (could)"), Color: github.String("cccccc")},
        {Name: github.String("priority 4 (maybe)"), Color: github.String("efefef")},
